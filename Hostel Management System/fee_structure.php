...
<a href="complaint.php"><span class="glyphicon glyphicon-list-alt"></span> Complaint </a>
  ...
  <p style="font-size:30px;">Status :</p>
  <?php
    echo "<div class='alert alert-success col-sm-5'>
    <strong>You have submitted your hostel fees. </strong>    
    </div>"
  ?>
</div>
