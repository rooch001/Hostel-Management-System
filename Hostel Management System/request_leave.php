...
<li>
            ...
            <div id="content">
                ...
                <div style="padding-top:120px;" class="col-md-12 col-sm-12 ">
                        ...
                        <p>Confirmation will be recieved through email or phone</p>
                        <p style="padding:10px;"></p>
                         ...
                         <form class="form-horizontal">
                             ...
                             <div class="form-group">
                              ...
                              <div class="form-group">
                                        <label class="control-label col-sm-2" for="driver">Driver Name</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control">
                                        </div>
                                    </div>
                             <div class="form-group">
                                        <label class="control-label col-sm-2" for="des">Destination</label>
                                        <div class="col-sm-5">
                                            <input type="text" class="form-control">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-2" for="npass">From</label>
                                        <div class="col-sm-2">
                                            <input type="date" class="form-control">
                                        </div>
                                        <label class="control-label col-sm-1" for="npass">To</label>
                                        <div class="col-sm-2">
                                            <input type="date" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-2" for="time">Estimated Arrival Time</label>
                                        <div class="col-sm-5">
                                            <input type="time" class="form-control">
                                        </div>
                                    </div>
